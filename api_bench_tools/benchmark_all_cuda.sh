...
function unittest() {
    ...
    echo "[BENCHMARK ${MODEL_SIZE}B TP${GPUS} TURNS$TURNS CLIENTS$CLIENTS RAMP_UP_TIME$RAMP_UP_TIME STOP_TIME$STOP_TIME ${MODE^^} BACKEND$BACKEND_ DATASET$DATASET]"
    INFO "[BENCHMARK ${MODEL_SIZE}B TP${GPUS} TURNS$TURNS CLIENTS$CLIENTS RAMP_UP_TIME$RAMP_UP_TIME STOP_TIME$STOP_TIME ${MODE^^} BACKEND$BACKEND_ DATASET$DATASET]"
